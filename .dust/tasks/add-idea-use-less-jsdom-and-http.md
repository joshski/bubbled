# Add Idea: Use less JSDOM and HTTP
...
A big reason for this framework existing is to use as little JSDOM and HTTP as possible for testing application code.

Find ways to run fewer of the todo-app tests in JSDOM. Do we need to move code out of JSX?
