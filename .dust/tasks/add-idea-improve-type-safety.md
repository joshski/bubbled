...
Look for opportunities to use type safety to improve code. Especially in the todo example app (e.g. do we need unknown types, can we remove any optional nulls)
