...
Without breaking the basic todo list app functionality (start with empty todo list, add todo, mark as done, mark as not done, delete todo) - also considering the goal of running no tests in a DOM, find every opportunity to remove code and simplify the example. Create an idea for each change
