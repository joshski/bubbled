...
**Decision:** Introduce a reusable projection state object


## Decomposes Idea

- [Split Bubble Browser Projector, Layout, and Event Bridges](../ideas/split-bubble-browser-projector-layout-and-event-bridges.md)
...
- The original idea (.dust/ideas/split-bubble-browser-projector-layout-and-event-bridges.md) is deleted or updated to reflect remaining scope
