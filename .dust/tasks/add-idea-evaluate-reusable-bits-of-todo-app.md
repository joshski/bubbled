# Add Idea: Evaluate reusable bits of todo app
...
Could any of the code in the todo app be “pushed down” into the framework and reused by other apps? Are any of the test utilities generic?
